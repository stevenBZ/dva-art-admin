...
function Sales ({ data }) {
  return (
    <div className={styles.sales}>
      <div className={styles.title}>机构运营数据</div>
      <ResponsiveContainer minHeight={360}>
        <LineChart data={data}>
          ...
          />
          <Line type="monotone" dataKey="机构实收" stroke={color.purple} strokeWidth={3} dot={{ fill: color.purple }} activeDot={{ r: 5, strokeWidth: 0 }} />
